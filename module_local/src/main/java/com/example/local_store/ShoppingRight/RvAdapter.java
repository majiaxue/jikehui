...
public abstract class RvAdapter<T> extends RecyclerView.Adapter<RvHolder> {
    ...
    protected ShopOnClickListtener shopOnClickListtener;
    protected LayoutInflater mInflater;
    private RecyclerView mRecyclerView;

    public RvAdapter(Context context, List<T> list, RvListener listener, ShopOnClickListtener shopOnClickListtener) {
        mContext = context;
