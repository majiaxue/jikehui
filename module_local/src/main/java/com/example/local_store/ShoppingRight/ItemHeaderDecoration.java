...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public ItemHeaderDecoration(Context context, List<LocalStoreBean.ListBean> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<LocalStoreBean.ListBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        View topTitleView = mInflater.inflate(R.layout.shopping_right_title, parent, false);
        TextView tvTitle = (TextView) topTitleView.findViewById(R.id.shopping_right_title_txt);
        tvTitle.setText(mDatas.get(pos).getName());
        //绘制title开始
