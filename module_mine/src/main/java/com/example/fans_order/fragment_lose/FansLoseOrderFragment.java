...
public class FansLoseOrderFragment extends BaseFragment<FansLoseOrderView, FansLoseOrderPresenter> implements FansLoseOrderView {
    ...
    public static FansLoseOrderFragment getInstance() {
        if (fragment == null) {
            synchronized (FansLoseOrderFragment.class) {
                if (fragment == null) {
                    fragment = new FansLoseOrderFragment();
                }
            }
        }
        return fragment;
    ...
    @Override
    public FansLoseOrderView createView() {
        return this;
    }

    @Override
    public FansLoseOrderPresenter createPresenter() {
        return new FansLoseOrderPresenter(getContext());
    }
}
