...
public class FansSettleOrderFragment extends BaseFragment<FansSettleOrderView, FansSettleOrderPresenter> implements FansSettleOrderView {
    ...
    public static FansSettleOrderFragment getInstance() {
        if (fragment == null) {
            synchronized (FansSettleOrderFragment.class) {
                if (fragment == null) {
                    fragment = new FansSettleOrderFragment();
                }
            }
        }
        return fragment;
    ...
    @Override
    public FansSettleOrderView createView() {
        return this;
    }

    @Override
    public FansSettleOrderPresenter createPresenter() {
        return new FansSettleOrderPresenter(getContext());
    }
}
