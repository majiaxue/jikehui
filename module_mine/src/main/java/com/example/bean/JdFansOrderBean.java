...
public class JdFansOrderBean {

    /**
     * id : 157
     * finishTime : 1560580065000
     * orderSn : 97679053305
     * parentId : 0
     * orderTime : 1560569242000
     * payMonth : 20190719
     * popId : 702720
     * actualCosPrice : 9.9
     * actualFee : 0.45
     * commissionRate : 5
     * estimateCosPrice : 9.9
     * estimateFee : 0.45
     * finalRate : 90
     * cid1 : 15901
     * frozenSkuNum : 0
     ...
     * siteId : 1712212846
     * skuId : 29912813068
     * skuName : 沐丝抽纸软抽纸原生木浆纸抽面巾纸4层300张包邮 8包包邮
     * skuNum : 1
     * skuReturnNum : 0
     * subSideRate : 90
     * subsidyRate : 0
     ...
     * subUnionId :
     * traceType : 2
     * ext1 : 304468286475599872
     * unionId : 702720
     * orderValidCode : 3
     * tenantId : 1
     * image : http://img14.360buyimg.com/n1/jfs/t27169/66/346532705/541715/63f15f2a/5b8f30bfNc153278d.jpg
     * backMoney : 0
    ...
    public void setSkuValidCode(String skuValidCode) {
    ...
    public String getOrderValidCode() {
        return orderValidCode;
    }

    public void setOrderValidCode(String orderValidCode) {
    ...
    public String toString() {
        return "JdFansOrderBean{" +
                ...
                ", skuValidCode='" + skuValidCode + '\'' +
                ", subUnionId='" + subUnionId + '\'' +
                ", traceType='" + traceType + '\'' +
                ", ext1='" + ext1 + '\'' +
                ", unionId='" + unionId + '\'' +
                ", orderValidCode='" + orderValidCode + '\'' +
                ", tenantId='" + tenantId + '\'' +
                ", image='" + image + '\'' +
                ", backMoney='" + backMoney + '\'' +
                ", fansIcon='" + fansIcon + '\'' +
