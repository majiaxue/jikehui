package com.example.view.addressselect;
...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = Color.parseColor("#fd3c15");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#fd3c15");
    //列表icon资源
    ...
    private void init(Context context) {
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.white));
        addView(grayLine);
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = Color.parseColor("#fd3c15");
